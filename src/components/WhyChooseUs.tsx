...
export default function WhyChooseUs() {
  return (
    <>
      ...
      <section className="text-white body-font bg-black py-4 gap-5">
        <div className="container flex flex-col-reverse md:flex-row items-center justify-evenly px-8 md:w-9/12 mx-auto gap-10 md:gap-20 h-auto">
        
          {/* Image Section */}
          <div className="flex flex-col space-y-4 md:space-x-10">
            <div className="flex flex-wrap justify-center gap-4 md:gap-5">
              ...
              />
              <Image
                className="object-cover w-full md:w-[200px] h-auto md:h-[230px] rounded-lg md:mt-16"
                alt="burger"
                src="/burger3.png"
                height={231}
                width={281}
