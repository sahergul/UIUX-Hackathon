...
const initialCartItems = [
  { name: "Burger", price: 10.99, quantity: 2, image: "./burger1.png" },
  { name: "Fresh Lime", price: 3.49, quantity: 1, image: "./drinks.png" },
  { name: "Pizza", price: 9.99, quantity: 4, image: "./mask1.png" },
  { name: "Chocolate Muffin", price: 4.49, quantity: 1, image: "./f4.png" },
  { name: "Cheese Butter", price: 11.99, quantity: 3, image: "./mask5.png" },
];
...
const ShoppingCart: React.FC = () => {
  ...
  return (
    <div className="bg-white font-sans">
      <Header heading="Shoping Cart" subheading="Shop" />
